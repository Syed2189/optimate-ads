	...
	public function setting_page_callback_fn() {
		...
		<div class="ssag-content-main">
			<div class="ssag-menu">
				...
				<div class="ssag-menu-item ssag-updates-btn" data-div="">	
					<a href="https://www.ezoic.com/?tap_a=124649-3adab2&tap_s=3095844-1b8980" target="_BLANK" rel="nofollow"><img src="https://static.tapfiliate.com/63d014a75e8a5990185067.png?a=124649-3adab2&s=3095844-1b8980" border="0"  style="width: 100%; max-width: 288px;" ></a>
									...
									<div class="ssag-posts-shortcode-options">
										<table class="ssag-column-1">
											...
											<tr>
												...
												<td>
													<p><?php echo esc_attr( '[ssag_ads_shortcode id="' . $key . '"]' ); ?></p>
												</td>
											</tr>
											<tr>
												<td class="widget">
												...
												<td>
													<p><?php echo esc_attr( '<?php if (function_exists ("optimate_ad")) echo optimate_ad(' . $key . '); ?>' ); ?></p>
												</td>
											</tr>
										</table>
									</div>
